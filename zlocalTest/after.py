...
class Module:
    @T.prim_func
    def long_lines(value_1: T.handle, c_idx_1: T.handle, idx_1: T.handle, vector_in: T.handle, res_t: T.handle, col_num_split: T.int32, row_num_real: T.int32, row_num_split: T.int32, col_num_real: T.int32):
        ...
        if 0 < row_num_split:
            ...
            Module.long_lines_kernel_3_1(buffer_1_idx.data, buffer_1_val.data, col_1_idx.data, res_val.data, vec_val.data, col_num_real, col_num_split, row_num_real, row_num_split)
        else:
