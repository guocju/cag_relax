...
class Module:
    ...
    def preprocess_gpu(indptr: T.handle, indices: T.handle, data: T.handle, row_idx_s: T.handle, col_idx_s: T.handle, val_s: T.handle, row_idx_l: T.handle, col_idx_l: T.handle, val_l: T.handle):
        T.func_attr({"func_type": "preprocess", "target": T.target("fpga")})
        row_add_one = T.int32()
        indptr_buffer = T.match_buffer(indptr, (row_add_one,), "int32")
        nnz4all = T.int32()
    ...
    @R.function
    def while_loop(alpha_tensor: R.Tensor((1,), dtype="float32", vdevice="cuda:0"), 
                   beta_tensor: R.Tensor((1,), dtype="float32", vdevice="cuda:0"), 
                   indptr: R.Tensor(("origin_row_add_1_",), dtype="int32", vdevice="cuda:0"), 
                   indices: R.Tensor(("origin_nnz_",), dtype="int32", vdevice="cuda:0"), 
                   data: R.Tensor(("origin_nnz_",), dtype="float32", vdevice="cuda:0"), 
                   vin: R.Tensor(("origin_row_",), dtype="float32", vdevice="cuda:0"), 
                   i: R.Tensor((), dtype="int32", vdevice="llvm:0")) -> R.Tensor(("origin_row_",), dtype="float32"):
        origin_row_ = T.int64()
        ...
        if cond1:
            with R.dataflow():
                ...
                lv: R.Tensor((origin_row_,), dtype="float32", vdevice="cuda:0") = cls.fused_short_lines_easier_gpu_long_lines_gpu(gv6, gv7, gv8, vin, gv10, gv11, gv12)
    ...
    @R.function
    def main(alpha_tensor: R.Tensor((1,), dtype="float32"), 
             beta_tensor: R.Tensor((1,), dtype="float32"), 
             indptr: R.Tensor(("origin_row_add_1",), dtype="int32"), 
             indices: R.Tensor(("origin_nnz",), dtype="int32"), 
             data: R.Tensor(("origin_nnz",), dtype="float32"), 
             vin: R.Tensor(("origin_col",), dtype="float32"), 
             iter_num: R.Tensor((), dtype="int32")) -> R.Tensor(("origin_col",), dtype="float32"):
        origin_col = T.int64()
